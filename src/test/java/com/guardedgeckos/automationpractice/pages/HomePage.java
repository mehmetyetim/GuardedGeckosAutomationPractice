...
public class HomePage extends BasePage {
    ...
    private final By textOnBiggestFirstImage = By.xpath("//a[@title='sample-1']/following-sibling::div/p[1]");
    private final By titleOnBiggestSecondImage = By.xpath("//a[@title='sample-2']/following-sibling::div/h2");
    private final By biggestImageSection = By.id("homeslider");
    private final By secondBiggestImage = By.xpath("//img[@alt='sample-2']");
